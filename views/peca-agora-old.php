					...
					<div class="content-cad-email col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="content-box-cad-email col-lg-5 col-md-5 col-sm-6 col-xs-6">
							<div class="box-cad-email col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<form class="frm-cadastro-email" id="frm-cad-email" action="http://liffe3x.com/wslh/controllers/clientes/index.php" method="post">
									
									<div class="form-group form-group-cad-email col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<input type="name" name="nome_cliente" class="form-control" id="InptName inpt-pa" placeholder="Digite seu nome">
									</div>
									<div class="form-group form-group-cad-email col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<input type="email" name="email_cliente" class="form-control" id="InptEmail inpt-pa" placeholder="Digite seu email">
									</div>
									<input type="hidden" name="urlretorno" value="http://www.biodryne.com.br/loja">
									
									<button type="submit" class="btn btn-warning btn-cad-email col-lg-12 col-md-12 col-sm-12 col-xs-12">CONTINUAR PARA VER<br/>PREÇOS E OFERTAS</button>
								</form>
