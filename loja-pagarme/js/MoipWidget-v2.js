...
(function() {
	...
	var MoipWidget = function(json) {//aqui recebe os dados 
		...
		jMoip(document).ready(function(jMoip) {
			param = {
				pagamentoWidget:{
					referer : requestUrl.href,//var requestUrl = window.location;//redirecionamento
		   ...
		   var conf = {
				url: URL + serviceUri,// https://desenvolvedor.moip.com.br/sandbox/rest/pagamento?callback=?
				type: "GET",
				dataType: "json",
				scriptCharset: "utf-8",
				async: true,
