            ...
            <div class="container container-product">
                <div class="container-fluid container-fluid-product">
                    ...
                    <div class="btn-group content-product col-lg-12 col-md-12 col-sm-12 col-xs-12" data-toggle="buttons">
                        ...
                        <div class="content-product-list col-lg-4 col-md-4 col-sm-4 col-xs-12" data-produtoid="004" data-price="35472">
                            <div class="btn product-two col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="radio" name="codigoproduto" id="codigoproduto codigoproduto2" autocomplete="off" value="CODBIOD004" hidden/>
                                ...
                                <div class="img-product img-product-two col-lg-12 col-md-12 col-sm-12 hidden-xs">
                                    <picture>
                                        <source media="(min-width: 1200px)" srcset="img/product/produto-4-1200.png">
                                            <source media="(min-width: 991px)" srcset="img/product/produto-4-991.png">
                                                <img src="img/product/produto-4.png" alt="product-two" />
                                    </picture>
                                </div>

                                <div class="discription-product col-lg-12 col-md-12 col-sm-12 hidden-xs">
                                    <span>
											Kit mais popular: Compre 3 e Leve 4 + Garantia de Satisfação + Risco Zero
										</span>
                                </div>
                                ...
                                <div class="content-text-p-two-xs hidden-lg hidden-md hidden-sm col-xs-6">
                                    ...
                                    <div class="price-product-xs price-product-two-xs hidden-lg hidden-md hidden-sm col-xs-12">
                                        ...
                                        <s>R$ 338,00</s>
                                        <h1 class="hidden-lg hidden-md hidden-sm col-xs-12">6x R$53,17</h1>
                                    </div>
                                </div>
                                ...
                                <div class="content-img-product-xs hidden-lg hidden-md hidden-sm col-xs-6">
                                    <div class="img-product-xs img-product-two-xs hidden-lg hidden-md hidden-sm col-xs-12">
                                        <picture>
                                            <source media="(min-width: 640px)" srcset="img/product/produto-4-640.png">
                                                <source media="(min-width: 480px)" srcset="img/product/produto-4-480.png">
                                                    <img src="img/product/produto-4-330.png" alt="product-two" />
                                        </picture>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="content-product-list col-lg-4 col-md-4 col-sm-4 col-xs-12 checked" data-produtoid="006" data-price="43170">
                            <div class="btn active product-three col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="radio" name="codigoproduto" id="codigoproduto codigoproduto3" autocomplete="off" value="CODBIOD006" checked hidden />
                                <div class="title-box-product title-box-product-three col-lg-12 col-md-12 col-sm-12 hidden-xs">
                                    <p>COMPRE 5 E LEVE</p>
                                    <h1>6 POTES</h1>
                                </div>
                                <div class="msg-discount-box-product col-lg-12 col-md-12 col-sm-12 hidden-xs">
                                    <span>1 potes grátis!</span>
                                </div>
                                <div class="img-product img-product-one col-lg-12 col-md-12 col-sm-12 hidden-xs">
                                    <picture>
                                        <source media="(min-width: 1200px)" srcset="img/product/produto-6-1200.png">
                                            <source media="(min-width: 991px)" srcset="img/product/produto-6-991.png">
                                                <img src="img/product/produto-6-769.png" alt="product-three">
                                    </picture>
                                </div>
                                <div class="discription-product col-lg-12 col-md-12 col-sm-12 hidden-xs">
                                    <span>
											Nossa melhor oferta: Compre 5 e Leve 6 + Satisfação 100% Garantida + Risco Zero.
										</span>
                                </div>
                                ...
                                <div class="content-text-p-three-xs hidden-lg hidden-md hidden-sm col-xs-6">
                                    ...
                                    <div class="msg-discount-box-product-xs hidden-lg hidden-md hidden-sm col-xs-12">
                                        <span class="discount-wid-640">1 potes grátis!</span>
                                        <span class="discount-wid-480 hidden">1 grátis!</span>
                                    </div>
                                    ...
                                    <div class="price-product-xs price-product-three-xs hidden-lg hidden-md hidden-sm col-xs-12">
                                        ...
                                        <s>R$ 507,00</s>
                                        <h1 class="hidden-lg hidden-md hidden-sm col-xs-12">6x R$66,00</h1>
                                    </div>
                                </div>
                                ...
                                <div class="content-img-product-xs hidden-lg hidden-md hidden-sm hidden-lg hidden-md hidden-sm col-xs-6">
                                    <div class="img-product-xs img-product-three-xs hidden-lg hidden-md hidden-sm col-xs-12">
                                        <picture>
                                            <source media="(min-width: 640px)" srcset="img/product/produto-6-640.png">
                                                <source media="(min-width: 480px)" srcset="img/product/produto-6-480.png">
                                                    <img src="img/product/produto-6-330.png" alt="product-three">
                                        </picture>
                                    </div>
                                </div>
                        ...
                        <div class="content-product-list col-lg-4 col-md-4 col-sm-4 col-xs-12" data-produtoid="002" data-price="24564">
                            <div class="btn product-one col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="radio" name="codigoproduto" id="codigoproduto codigoproduto1" autocomplete="off" value="CODBIOD002" hidden />
                                ...
                                <div class="img-product img-product-one col-lg-12 col-md-12 col-sm-12 hidden-xs">
                                    <picture>
                                        <source media="(min-width: 1200px)" srcset="img/product/produto-2-1200.png">
                                            <source media="(min-width: 991px)" srcset="img/product/produto-2-991.png">
                                                <img src="img/product/produto-2-769.png" alt="product-one">
                                    </picture>
                                </div>

                                <div class="discription-product col-lg-12 col-md-12 col-sm-12 hidden-xs">
                                    <span>Pacote inicial: Compre 1 e Leve 2 + Satisfação Garantida + Risco Zero.</span>
                                </div>
                                ...
                                <div class="content-text-p-one-xs hidden-lg hidden-md hidden-sm col-xs-6">
                                    ...
                                    <div class="price-product-xs price-product-two-xs hidden-lg hidden-md hidden-sm col-xs-12">
                                        ...
                                        <s>R$ 169,00</s>
                                        <h1 class="hidden-lg hidden-md hidden-sm col-xs-12">6x R$34,99</h1>
                                    </div>
                                </div>
                                ...
                                <div class="content-img-product-xs hidden-lg hidden-md hidden-sm col-xs-6">
                                    <div class="img-product-xs img-product-one-xs hidden-lg hidden-md hidden-sm col-xs-12">
                                        <picture>
                                            <source media="(min-width: 640px)" srcset="img/product/produto-2-640.png">
                                                <source media="(min-width: 480px)" srcset="img/product/product-one-480.png">
                                                    <img src="img/product/produto-2-330.png" alt="product-one">
                                        </picture>
                                    </div>
                                </div>
