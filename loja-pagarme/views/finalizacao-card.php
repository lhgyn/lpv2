...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://liffehealth.com.br/wslh/controllers/pagarme/getTransacaoWS/".$idTransacaoMoip);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true); 
$dadosCompra = curl_exec($ch);
curl_close($ch);
$dados = json_decode($dadosCompra);
$nome = $dados->nome_completo;
$datahora = date('d/m/Y H:i:s', strtotime($dados->created));
$data = date('d/m/Y', strtotime("+1 days",strtotime($dados->created)));
...
if($codigo == "CODBIOD002"){
	$imagemproduto = "produto-2-330.png";
}elseif($produto == "CODBIOD004"){
	$imagemproduto = "produto-4-330.png";
}else{
	$imagemproduto = "produto-6-330.png";
}
		...
		<div class="row-congratulate container">
			<div class="container-fluid">
				<div class="content-left-congralate col-lg-9 col-lg-9 col-sm-8 col-xs-12">
					<div class="box-title">
						<h1>Obrigado, <?php echo $nome; ?><span class="nomeCliente"></span></h1>
						<h2>Recebemos seu pedido!</h2>
					</div>
					<p class="box-text">
						Seu pedido está pré-aprovado. <strong>Estamos aguardando a confirmação do pagamento pelo Cartão de Crédito!</strong>
					</p>
				</div>
		...
		<div class="row-inf-email-entrega container">
			<div class="container-fluid">
				...
				<div class="box-description box-description-entrega col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<p><span class="fa fa-truck fa-3x"></span> Seu pedido será enviado aos Correios no primeiro dia útil após a confirmação do pagamento. Nós o manteremos sempre atualizado sobre o status do seu pedido.</p>
				</div>
			</div>
		</div>
				...
				<div class="row-pedido col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="purchase-description">
						<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
							...
							<div class="value-pedido"><span class="nomeCliente"><?php echo $nome; ?></span></div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
							<div class="description-pedido">Número do pedido</div>
							<div class="value-pedido"><span class="code-transacao"><?php echo $idTransacaoMoip; ?></span></div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
							<div class="description-pedido">Realizado em</div>
							<div class="value-pedido"><span class="data-pedido"><?php echo $datahora; ?></span></div>
						</div>
					</div>
				</div>
					...
					<div class="content-pedido col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="pedido-total col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="content-img-product col-lg-2 col-md-2 col-sm-2 col-xs-4">
								<img class="img-product" alt="product" src="../img/product/<?php echo $imagemproduto; ?>">
							</div>
							<div class="col-lg-4 col-md-4 col-sm-4 hidden-xs">
								<span class="nomeProduto"><?php echo $produto; ?></span>
							</div>
							<div class="col-lg-2 col-md-2 col-sm-2 hidden-xs">
								<span class="price">R$ <?php echo $valor-$frete; ?></span>
							</div>
							<div class="col-lg-2 col-md-2 col-sm-2 hidden-xs">
								<span class="qtddProduto">1</span>
							</div>
							<div class="col-lg-2 col-md-2 col-sm-2 hidden-xs">
								<span class="price-total">R$ <?php echo $valor-$frete; ?></span>
							</div>
				...
				<section class="row-info-pedido user-info col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="payment-info col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="type col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="info col-lg-10 col-md-10 col-sm-10 col-xs-12">
								...
								<p class="venc-boleto">Vencimento: <span class="data_vencimento"><?php echo $data; ?></span></p>
								<div id="button" class="button" data-anchor="boleto">
									<div class="bt-content" id="button-paymentinfo">
										<a class="btn btn-view-boleto btn-success btn-sm" href="<?php echo $Boleto; ?>" target="_blank">VISUALIZAR</a>
									</div>
								</div>
							</div>
						</div>
						<div class="row-info-shipping shipping col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 item-shipping">
								...
								<span class="price-frete info-shipping col-lg-12 col-md-12 col-sm-12 col-xs-12">R$ <?php echo $frete; ?></span>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 item-shipping">
								<span class="description-pedido col-lg-12 col-md-12 col-sm-12 col-xs-12">Valor dos Produtos</span>
								<span class="price-produto info-shipping col-lg-12 col-md-12 col-sm-12 col-xs-12">R$ <?php echo $valor-$frete; ?></span>
							</div>
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 item-shipping ">
								...
								<span class="price-total total-info-shipping col-lg-12 col-md-12 col-sm-12 col-xs-12">R$ <?php echo $valor; ?></span>
							</div>
						</div>
					</div>
					<div class="payment-shipping col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<dl>
							...
							<dd class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="nomeCliente"><?php echo $nome; ?></span></dd>
							<dt class="description-pedido col-lg-12 col-md-12 col-sm-12 col-xs-12">Email</dt>
							<dd class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="nomeEmail"><?php echo $email; ?></span></dd>
							<dt class="description-pedido col-lg-12 col-md-12 col-sm-12 col-xs-12">Telefone</dt>
							<dd class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="telefone"><?php echo $telefone; ?></span></dd>
							<dt class="description-pedido col-lg-12 col-md-12 col-sm-12 col-xs-12">Endereço</dt>
							<dd class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="enderecoCompleto"><?php echo $endereco."<br />Número: ".$numero."<br />Bairro: ".$bairro."<br />Complemento: ".$complemento."<br />Cidade: ".$cidade."<br />Estado: ".$estado; ?></span></dd>
						</dl>
					</div>
				</section>
	                ...
	                <div class="content-rodape-checkout">
	                    ...
	                    <div class="content-right-rodape col-lg-6 col-md-6 col-sm-6 col-xs-12">
	                        <p>
	                            ...
	                            <span class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Av. Perimetral, 848, Qd. 21 Lt. 24<br/>
	                            Setor Campinas - Goiânia-GO - CEP: 74520-110</span>
	                        </p>
	                    </div>
