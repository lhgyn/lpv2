												  			...
												  			<div class="row">
														  		<div class="col-xs-12">	
														  			<form action="https://www.bcash.com.br/checkout/car/" method="post" target="carrinho">
																	  	<p class="product-name">LEVE 6 <strong>(2 GRÁTIS)</strong></p>
																	  	<p class="product-price"><span><s class="old-price">DE R$809,40</s></span><br/><span>Por apenas</span><br>6x R$66,00</p>
																		...
																		<input type="hidden" value="Biodryne Rx (6 Potes + Frete Grátis)" name="nome_prod">
																		<input type="hidden" value="396.00" name="valor_prod">
																		<input type="hidden" value="000" name="peso_prod">
																		<input type="hidden" name="quant_prod" value="1">
																		<input type="hidden" value="http://liffehealth.com.br/wslh/controllers/retornoBCash/index.php" name="url_aviso">
											  		...
											  		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center content-txt-product-two">
											  			<div class="txt-product-two">
													  		<div class="row">
														  		<div class="col-xs-12">
														  			<form action="https://www.bcash.com.br/checkout/car/" method="post" target="carrinho">
																  		<p class="product-name">LEVE 4<br><strong>(1 GRÁTIS)</strong></p>
																		<p class="product-price"><span><s class="old-price">DE R$539,60</s></span><br/><span>Por apenas</span><br>6x R$53,17</p>
																		<input type="hidden" value="add" name="acao">
																		<input type="hidden" value="contato@lifehealth24h.com" name="email_loja"> 
																		<input type="hidden" value="2SEO_LIFE0002" name="cod_prod">
																		<input type="hidden" value="Biodryne Rx (4 Potes)" name="nome_prod">
																		<input type="hidden" value="319.02" name="valor_prod">
											  		...
											  		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center content-txt-product-three">
												  		<div class="txt-product-two">
													  		<div class="row">
														  		<div class="col-xs-12">
														  			<form action="https://www.bcash.com.br/checkout/car/" method="post" target="carrinho">
																  		<p class="product-name">LEVE 2</p>
																		<p class="product-price"><span><s class="old-price">DE R$269,80</s></span><br/><span>Por apenas</span><br>6x R$34,99</p>
																		<input type="hidden" value="add" name="acao">
																		<input type="hidden" value="contato@lifehealth24h.com" name="email_loja"> 
																		<input type="hidden" value="2SEO_LIFE0003" name="cod_prod">
																		<input type="hidden" value="Biodryne Rx (2 Potes)" name="nome_prod">
																		<input type="hidden" value="209.94" name="valor_prod">
																		<input type="hidden" value="250" name="peso_prod">
																		<input type="hidden" name="quant_prod" value="1">
																		<input type="hidden" value="http://liffehealth.com.br/wslh/controllers/retornoBCash/index.php" name="url_aviso">
