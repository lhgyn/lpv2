(function () {
	...
	"undefined" != typeof module && module.exports && (module.exports = t), t.languages.clike = {
		...
		return $(".demo .numbers li").wrapInner('<a href="#"></a>').click(function (e) {
			return e.preventDefault(), $(".demo .numbers").slideUp(100), $("#numerocartao").val($(this).text()).trigger("input")
		}), $("body").click(function () {
			...
			opacity: 0
		}), $("#numerocartao").validateCreditCard(function (e) {
			...
			accept: ["visa", "mastercard", "amex", "diners", "hipercard", "elo"]
		})
	})
}).call(this);