	...
	$(document).ready(function () {
		$('#form-cad-deliveri').validate({
			...
			submitHandler: function (form) {
				...
				var url = 'http://liffehealth.com.br/wslh/controllers/webservice/vendaCliente';
					...
					success: function (data) {
						...
						if (data.status != "") {
							if (data.Forma == 'BoletoBancario') {
								location.href = 'views/finalizacao-boleto.php?token=' + data.Token + '&codigo=' + data.IdTransacao + '&mensagem=' + data.Mensagem;
							} else {
								location.href = 'views/finalizacao-card.php?codigo=' + data.IdTransacao + '&mensagem=' + data.Mensagem;
							}
						} else {
							//ModalErroCartao(data.Mensagem);
							$('#TB_overlay').css("display", "block");
							$('#TB_window').css("display", "block");
							$('.msg-serv').html(data.Mensagem);
						}
					}
