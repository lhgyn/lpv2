			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 right">
						<ul>
							<li><i class="flaticon-check"></i> Completa</li>
							<li><i class="flaticon-check"></i> Sinérgica</li>
							<li><i class="flaticon-check"></i> Potente</li>
							<li><i class="flaticon-check"></i> Comprovada</li>
						</ul>
					</div>
					<div class="col-md-6 left">
		    ...
		    <section id="guarantee-block">
		    	<div class="container">
		    		...
		    		<div class="col-md-12 bg-transparent">
		    			<div class="col-md-4">
			    			<img class="img-responsive" src="./assets/img/selo-garantia.png" alt="" style="margin: 0 auto; max-width: 250px">
			    		</div>
			    		<div class="col-md-8">
