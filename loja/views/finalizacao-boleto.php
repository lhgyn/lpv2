				...
				<section class="action">
					<div class="action-1">
						...
						<div class="row ">
							...
							<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 box-btn-print">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div id="MoipWidget"
									data-token="<?php echo($token); ?>"
									callback-method-success="funcaoSucesso"
									callback-method-error="funcaoFalha"></div>
									<a class="btn btn-print-boleto btn-success btn-lg" id="pagarBoleto" onclick="pagarBoleto()">IMPRIMIR BOLETO</a>
								</div>
							</div>
						</div>
						<div id="row-iframe-moip" class="row row-iframe-moip">
							<iframe src="https://www.moip.com.br/Instrucao.do?token=<?php echo($token);?>" class="iframe-boleto" width="100%" height="400px" marginwidth="0" marginheight="0" frameborder="0" vspace="0" hspace="0"></iframe>
						</div>
					</div>
				</section>
			</div>
