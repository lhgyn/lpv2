<?php
$nome = (isset($_GET['nome']) && !empty($_GET['nome'])) ? $_GET['nome'] : NULL;
                    ...
                    <div class="content-remaining-steps col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        ...
                        <div class="content-frm-deliveri col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group nome-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <input class="form-control" name="cliente_nome" id="cliente_nome" type="text" value="<?php echo $nome; ?>" placeholder="Nome" />
                            </div>
                            <div class="form-group sobrenome-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <input class="form-control" name="cliente_sobrenome" id="cliente_sobrenome" type="text" placeholder="Sobrenome" />
                            </div>
                            ...
                            <div class="col-lg-6 form-group msg-address-group col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group numero-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        ...
                        <div class="content-frm-pagament col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="title-frm-pagament title-etapa-checkout col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="powered-copy col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <div class="img-powered col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <img src="img/logo-moip.svg">
                                    </div>
                                    <small class="txt-powered col-lg-12 col-md-12 col-sm-12 col-xs-12">POWERED</small>
                                </div>
                            </div>
                            ...
                            <div class="content-type-payment col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                ...
                                <div class="content-payment-card col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group num-card-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <input class="form-contro2" id="numerocartao" name="numerocartao" type="text" placeholder="Digite o n&uacute;mero do cart&atilde;o" minLength="17" data-mask="9999 9999 9999 99" />
                            ...
                            <div class="icon-amb-security hidden-lg hidden-md col-sm-6 col-xs-6">
                            ...
                            <div class="icon-vendedor hidden-lg hidden-md col-sm-6 col-xs-6">
                ...
                <div class="content-rodape-checkout">
                    ...
                    <div class="content-left-rodape col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <ul class="menu-rodape-checkout col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <li><a href="politica-privacidade.php"><i class="fa fa-caret-right"></i> Politica de Pricacidade</a>
                            </li>
                            <li><a href="politica-reembolso.php"><i class="fa fa-caret-right"></i> Politica de Reembolso</a>
                            </li>
                            <li class="li-contato">
